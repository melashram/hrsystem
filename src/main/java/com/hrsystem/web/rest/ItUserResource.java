...
import com.hrsystem.repository.ItUserRepository;
...
public class ItUserResource {
    ...
    @Timed
    public ResponseEntity<ItUser> createItUser(@Valid @RequestBody ItUser itUser) throws URISyntaxException {
    ...
    @PutMapping("/it-users")
    @Timed
    public ResponseEntity<ItUser> updateItUser(@Valid @RequestBody ItUser itUser) throws URISyntaxException {
