...
import com.hrsystem.repository.HumanResourceUserRepository;
...
public class HumanResourceUserResource {
    ...
    @Timed
    public ResponseEntity<HumanResourceUser> createHumanResourceUser(@Valid @RequestBody HumanResourceUser humanResourceUser) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<HumanResourceUser> updateHumanResourceUser(@Valid @RequestBody HumanResourceUser humanResourceUser) throws URISyntaxException {
