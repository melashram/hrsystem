...
import com.hrsystem.service.util.RandomUtil;
import com.hrsystem.service.dto.UserDTO;
...
public class UserService {
    ...
    public Optional<User> activateRegistration(String key) {
        ...
        return userRepository.findOneByActivationKey(key)
            .map(user -> {
                ...
                user.setAuthorities(authorityRepository.findRoleEmployee());
    ...
    public User registerUser(UserDTO userDTO, String password , String personalPhoneNumber  ,
        ...
        Authority authority = authorityRepository.findOne(AuthoritiesConstants.EMPLOYEE);
